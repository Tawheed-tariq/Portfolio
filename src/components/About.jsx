...
export default function About(){
    return(
        <>
        <div className={` gap-[25px] w-full h-[50%] flex flex-col justify-center items-center pt-[90px] px-[250px]`}>
        ...
        <div className={`px-[250px] pt-[50px]`}>
        ...
        <div className={`px-[250px] w-full flex justify-center`}>
